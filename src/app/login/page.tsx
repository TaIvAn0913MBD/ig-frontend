...
const Login = () => {
  ...
  return (
    <div className="h-screen bg-black w-screen flex justify-center items-center">
      <Card
        className="bg-black px-7 flex flex-col items w-min h-3/6
      "
      >
        <CardHeader>
        ...
        <CardContent className="flex flex-col justify-between mt-14 h-2/5 ">
          <div className="flex flex-col justify-around h-3/4 pb-4">
            <Input
            ...
            />
            {usernameErr ? <div className="text-red-500">aldaa</div> : null}
            ...
            <Input
              ...
              className="border-neutral-500 w-64 text-sm text-white"
            />
            {passErr ? <div className="text-red-500">aldaa</div> : null}
          </div>
          <Button
        ...
        <CardFooter className="mt-14 flex flex-col justify-center">
